...
//
//	mockgen -package neighbor -destination=mock_request_test.go github.com/v-byte-cpu/sx/pkg/scan RequestGenerator
//

// Package neighbor is a generated GoMock package.
package neighbor
...
func (m *MockRequestGenerator) GenerateRequests(ctx context.Context, r *scan.Range) (<-chan *scan.Request, error) {
	m.ctrl.T.Helper()
