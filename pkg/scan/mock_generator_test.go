...
//
//	mockgen -package scan -destination=mock_generator_test.go -source generator.go
//
...
func (m *MockPacketFiller) Fill(arg0 gopacket.SerializeBuffer, r *Request) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Fill", arg0, r)
	ret0, _ := ret[0].(error)
	return ret0
}

// Fill indicates an expected call of Fill.
func (mr *MockPacketFillerMockRecorder) Fill(arg0, r any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Fill", reflect.TypeOf((*MockPacketFiller)(nil).Fill), arg0, r)
}
...
func (mr *MockPacketGeneratorMockRecorder) Packets(ctx, in any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
