...
//
//	mockgen -destination=mock_receiver_test.go -package=packet -source receiver.go
//
...
func (mr *MockProcessorMockRecorder) ProcessPacketData(data, ci any) *gomock.Call {
